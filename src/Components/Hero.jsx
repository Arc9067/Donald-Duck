...
const Hero = () => {
  return (
    <section
      className="pt-[120px] pb-[100px] w-full flex justify-center   items-center relative"
      id="hero"
    >
      <svg
        width="356"
      ...
      <div className="container flex flex-col justify-center items-center relative">
        ...
        <img
          src={Hero2}
          alt=""
          className="absolute top-10 right-0 w-14 lg:w-28"
        />
        <h2 className="text-[#000] text-2xl font-ultra">Welcome To </h2>
